...
function ProjectCard(props : {project_svg_name : string, alt_text : string}){
  ...
  return (
    <InView as="div" onChange={(inView, entry) => {entry.target.children[0].classList.add('shown')}} className={`transition-opacity duration-1000 hid ${inView ? 'opacity-100 shown' : 'opacity-0'}`}>
