...
be placed into a random empty cell</p>
    <figure>
      <Image className="!relative" fill  src="simple_dqn/snake.png" alt={""}></Image>
...
its death in 3 steps. The average food eaten is negligible and most likely only because of the random placement of food.</p>
  ...
  <figure>
  <Image className="!relative" fill  src="simple_dqn/results.png" alt={""}></Image>
...
iterations in training
  ...
  <figure>
  <Image className="!relative" fill  src="simple_dqn/foodVsIteration.png" alt={""}></Image>
  ...
  <figure>
  <Image className="!relative" fill  src="simple_dqn/eval.png" alt={""}></Image>
  ...
  <figure>
  <Image className="!relative" fill  src="simple_dqn/eval2.png" alt={""}></Image>
