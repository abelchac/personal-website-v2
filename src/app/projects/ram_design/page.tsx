...
export default function RAM_Project() {
  ...
  <section><Image className="!relative" fill  src="ram_design/ramlayout.png" alt={""}></Image></section>
...
after the new input values are processed.
    ...
    <figure>
      <Image className="!relative" fill  src="ram_design/decoder.png" alt={""}></Image>
  ...
  let tristate_buffer = FadeInFactory(<div><section>
    ...
    <figure>
     <Image className="!relative" fill  src="ram_design/tristate_buffer_1.png" alt={""}></Image> 
     <figcaption>Figure 1.2: Tri-state buffer design to be used in the column driver
     </figcaption>
    </figure>
    <figure>
     <Image className="!relative" fill  src="ram_design/tristate_buffer_2.png" alt={""}></Image> 
    ...
    let memory_cell = FadeInFactory(<div><section>
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/6t_sram.png" alt="" />
...
words of length 4 bits.</p>
      <figure>
        <Image className="!relative" fill  src="ram_design/mem_col.png" alt="" />
...
be the one that is coinciding with the rising edge of the clock.
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/io_bus.png" alt="" />
...
read on the D0-3 lines.
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/full_ram.png" alt="" />
    ...
    let validation_tri_state = FadeInFactory(<div><section>
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/tristate_val.png" alt="" />
        <figcaption>Figure 2.4: Test setup for the tri-state buffer
        </figcaption>
      </figure>
      <figure>
        <Image className="!relative" fill  src="ram_design/tristate_inverter_val.png" alt="" />
        <figcaption>Figure 2.5: Test setup for the tri-state inverter
        </figcaption>
      </figure>
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_6.png" alt="" />
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_7.png" alt="" />
...
the overwrite.
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_8.png" alt="" />
...
The 2 transistors emulate the bitline capacitance that would be seen in the full 16 word memory.
    ...
    <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_9.png" alt="" />
        <figcaption>Figure 2.9:Annotated Plot of in, out, RE, and WE</figcaption>
      </figure>

      <div  className="grid grid-cols-2 gap-x-2 gap-y-2 ">
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_10.png" alt="" />
        <figcaption>Figure 2.10: Plot of WE</figcaption>
      </figure>

      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_11.png" alt="" />
        <figcaption>Figure 2.11: Plot of In</figcaption>
      </figure>

      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_12.png" alt="" />
        <figcaption>Figure 2.12: Plot of out and RE.</figcaption>
      </figure>

      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_13.png" alt="" />
...
the column</p>
<figure>
        <Image className="!relative" fill  src="ram_design/figure_2_14.png" alt="" />
...
the most significant bit.</p>
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_15.png" alt="" />
        <figcaption>Figure 2.15: The design for a 1 word (4 bit) testing
        </figcaption>
      </figure>
      <br></br>
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_16.png" alt="" />
      ...
      <div  className="grid grid-cols-2 gap-x-2 gap-y-2 ">
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_17.png" alt="" />
        <figcaption>Figure 2.17: Plot of d0</figcaption>
      </figure>

      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_18.png" alt="" />
        <figcaption>Figure 2.18: Plot of d1</figcaption>
      </figure>

      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_19.png" alt="" />
        <figcaption>Figure 2.19: Plot of d2.</figcaption>
      </figure>

      <figure>
        <Image className="!relative" fill  src="ram_design/figure_2_20.png" alt="" />
    ...
    let figure_2_21 = FadeInFactory(<figure>
      <Image className="!relative" fill  src="ram_design/figure_2_21.png" alt="" />
      <figcaption>Figure 2.21: The design for a 16 word (4 bit) testing</figcaption>
    </figure>);

    let figure_2_22 = FadeInFactory(<figure>
      <Image className="!relative" fill  src="ram_design/figure_2_22.png" alt="" />
    ...
    let figure_2_23 = FadeInFactory(<figure>
      <Image className="!relative" fill  src="ram_design/figure_2_23.png" alt="" />
    ...
    let figure_2_24 = FadeInFactory(<figure>
      <Image className="!relative" fill  src="ram_design/figure_2_24.png" alt="" />
    ...
    let figure_2_25 = FadeInFactory(<figure>
      <Image className="!relative" fill  src="ram_design/figure_2_25.png" alt="" />
    ...
    let figure_2_29 = FadeInFactory(<figure>
      <Image className="!relative" fill  src="ram_design/figure_2_29.png" alt="" />
    ...
    let figure_2_30 = FadeInFactory(<figure>
      <Image className="!relative" fill  src="ram_design/figure_2_30.png" alt="" />
...
Testing operation(1 cell in memory): W0 R0 R0 W1 R1 R1 W0 R0 W1 R1 W1 R1 W0 R0</p>
    ...
    let delay = FadeInFactory(<div><section>
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_3_1.png" alt="" />
    ...
    let power = FadeInFactory(<div><section>
      ...
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_3_2.png" alt="" />
        <figcaption>Figure 3.2: The voltage pulse that are inputs into the decoder</figcaption>
      </figure>
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_3_3.png" alt="" />
        <figcaption>Figure 3.3: The voltage pulse that drives the input into the memory
        </figcaption>
      </figure>
      <figure>
        <Image className="!relative" fill  src="ram_design/figure_3_4.png" alt="" />
        <figcaption>Figure 3.4: The plot of the voltage that drives the input into the memory
        </figcaption>
      </figure>
      <Image className="!relative" fill  src="ram_design/yint.png" alt="" />
