...
export default function RAM_Project() {
  ...
  <section><Image src="ram_design/ramlayout.png" alt={""}></Image></section>
...
after the new input values are processed.
    ...
    <figure>
      <Image src="ram_design/decoder.png" alt={""}></Image>
  ...
  let tristate_buffer = FadeInFactory(<div><section>
    ...
    <figure>
     <Image src="ram_design/tristate_buffer_1.png" alt={""}></Image> 
     <figcaption>Figure 1.2: Tri-state buffer design to be used in the column driver
     </figcaption>
    </figure>
    <figure>
     <Image src="ram_design/tristate_buffer_2.png" alt={""}></Image> 
    ...
    let memory_cell = FadeInFactory(<div><section>
      ...
      <figure>
        <Image src="ram_design/6t_sram.png" alt="" />
...
words of length 4 bits.</p>
      <figure>
        <Image src="ram_design/mem_col.png" alt="" />
...
be the one that is coinciding with the rising edge of the clock.
      ...
      <figure>
        <Image src="ram_design/io_bus.png" alt="" />
...
read on the D0-3 lines.
      ...
      <figure>
        <Image src="ram_design/full_ram.png" alt="" />
    ...
    let validation_tri_state = FadeInFactory(<div><section>
      ...
      <figure>
        <Image src="ram_design/tristate_val.png" alt="" />
        <figcaption>Figure 2.4: Test setup for the tri-state buffer
        </figcaption>
      </figure>
      <figure>
        <Image src="ram_design/tristate_inverter_val.png" alt="" />
        <figcaption>Figure 2.5: Test setup for the tri-state inverter
        </figcaption>
      </figure>
      <figure>
        <Image src="ram_design/figure_2_6.png" alt="" />
      ...
      <figure>
        <Image src="ram_design/figure_2_7.png" alt="" />
...
the overwrite.
      ...
      <figure>
        <Image src="ram_design/figure_2_8.png" alt="" />
...
the column</p>
<figure>
        <Image src="ram_design/figure_2_14.png" alt="" />
...
the most significant bit.</p>
      <figure>
        <Image src="ram_design/figure_2_15.png" alt="" />
        <figcaption>Figure 2.15: The design for a 1 word (4 bit) testing
        </figcaption>
      </figure>
      <br></br>
      <figure>
        <Image src="ram_design/figure_2_16.png" alt="" />
      ...
      <div  className="grid grid-cols-2 gap-x-2 gap-y-2 ">
      <figure>
        <Image src="ram_design/figure_2_17.png" alt="" />
        <figcaption>Figure 2.17: Plot of d0</figcaption>
      </figure>

      <figure>
        <Image src="ram_design/figure_2_18.png" alt="" />
        <figcaption>Figure 2.18: Plot of d1</figcaption>
      </figure>

      <figure>
        <Image src="ram_design/figure_2_19.png" alt="" />
        <figcaption>Figure 2.19: Plot of d2.</figcaption>
      </figure>

      <figure>
        <Image src="ram_design/figure_2_20.png" alt="" />
    ...
    let figure_2_23 = FadeInFactory(<figure>
      <Image src="ram_design/figure_2_23.png" alt="" />
    ...
    let figure_2_24 = FadeInFactory(<figure>
      <Image src="ram_design/figure_2_24.png" alt="" />
    ...
    let figure_2_25 = FadeInFactory(<figure>
      <Image src="ram_design/figure_2_25.png" alt="" />
    ...
    let figure_2_29 = FadeInFactory(<figure>
      <Image src="ram_design/figure_2_29.png" alt="" />
    ...
    let figure_2_30 = FadeInFactory(<figure>
      <Image src="ram_design/figure_2_30.png" alt="" />
...
Testing operation(1 cell in memory): W0 R0 R0 W1 R1 R1 W0 R0 W1 R1 W1 R1 W0 R0</p>
    ...
    let delay = FadeInFactory(<div><section>
      ...
      <figure>
        <Image src="ram_design/figure_3_1.png" alt="" />
