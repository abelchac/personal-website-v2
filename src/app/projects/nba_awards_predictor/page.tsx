...
following their teammates and teammates of those teammates to another MVP.
  ...
  let startScreen = FadeInFactory(<div>
    ...
    <img   src="nba_awards_predictor/start.png" alt={""}></img >
  </div>);

  let buttons = FadeInFactory(<div>

    <h2>Buttons:</h2>
    <img   src="nba_awards_predictor/buttons.png" alt={""}></img >
...
<img   src="nba_awards_predictor/mvp.png" alt={""}></img >
  </div>);
...
candidate.</p>
  <img   src="nba_awards_predictor/mvp_sliders.png" alt={""}></img >
...
let mvp_score = FadeInFactory(<div>
  ...
  <img   src="nba_awards_predictor/mvp_score.png" alt={""}></img >
...
This column is auto sorted so that the player with the highest score is at the top.</p>
  <img   src="nba_awards_predictor/dpoy.png" alt={""}></img >
...
candidate</p>
  <img   src="nba_awards_predictor/dpoy_sliders.png" alt={""}></img >
...
let dpoy_score = FadeInFactory(<div>
  ...
  present in the frame, so that the user can see how all the weights apply.</p>
  <img   src="nba_awards_predictor/dpoy_score.png" alt={""}></img >
...
This column is auto sorted so that the player with the highest score is at the top.
  ...
  <img   src="nba_awards_predictor/roy.png" alt={""}></img >
...
candidate.</p>
  <img   src="nba_awards_predictor/roy_sliders.png" alt={""}></img >
...
let roty_score = FadeInFactory(<div>
  ...
  present in the frame, so that the user can see how all the weights apply</p>
  <img   src="nba_awards_predictor/roy_score.png" alt={""}></img >
...
graph being built on another thread</p>
  <img   src="nba_awards_predictor/mvp_bfs.png" alt={""}></img >
