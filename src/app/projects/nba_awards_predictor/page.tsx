...
candidate.</p>
  <img src="nba_awards_predictor/mvp_sliders.png"></img>
...
let mvp_score = fadeInFactory(<div>
  ...
  <img src="nba_awards_predictor/mvp_score.png"></img>
...
This column is auto sorted so that the player with the highest score is at the top.</p>
  <img src="nba_awards_predictor/dpoy.png"></img>
...
candidate</p>
  <img src="nba_awards_predictor/dpoy_sliders.png"></img>
...
let dpoy_score = fadeInFactory(<div>
  ...
  present in the frame, so that the user can see how all the weights apply.</p>
  <img src="nba_awards_predictor/dpoy_score.png"></img>
...
This column is auto sorted so that the player with the highest score is at the top.
  ...
  <img src="nba_awards_predictor/roy.png"></img>
...
candidate.</p>
  <img src="nba_awards_predictor/roy_sliders.png"></img>
...
let roty_score = fadeInFactory(<div>
  ...
  present in the frame, so that the user can see how all the weights apply</p>
  <img src="nba_awards_predictor/roy_score.png"></img>
...
graph being built on another thread</p>
  <img src="nba_awards_predictor/mvp_bfs.png"></img>
