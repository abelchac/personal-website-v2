...
following their teammates and teammates of those teammates to another MVP.
  ...
  let startScreen = FadeInFactory(<div>
    ...
    <Image src="nba_awards_predictor/start.png" alt={""}></Image>
  </div>);

  let buttons = FadeInFactory(<div>

    <h2>Buttons:</h2>
    <Image src="nba_awards_predictor/buttons.png" alt={""}></Image>
...
<Image src="nba_awards_predictor/mvp.png" alt={""}></Image>
  </div>);
...
candidate.</p>
  <Image src="nba_awards_predictor/mvp_sliders.png" alt={""}></Image>
...
let mvp_score = FadeInFactory(<div>
  ...
  <Image src="nba_awards_predictor/mvp_score.png" alt={""}></Image>
...
This column is auto sorted so that the player with the highest score is at the top.</p>
  <Image src="nba_awards_predictor/dpoy.png" alt={""}></Image>
...
candidate</p>
  <Image src="nba_awards_predictor/dpoy_sliders.png" alt={""}></Image>
...
let dpoy_score = FadeInFactory(<div>
  ...
  present in the frame, so that the user can see how all the weights apply.</p>
  <Image src="nba_awards_predictor/dpoy_score.png" alt={""}></Image>
...
This column is auto sorted so that the player with the highest score is at the top.
  ...
  <Image src="nba_awards_predictor/roy.png" alt={""}></Image>
...
candidate.</p>
  <Image src="nba_awards_predictor/roy_sliders.png" alt={""}></Image>
...
let roty_score = FadeInFactory(<div>
  ...
  present in the frame, so that the user can see how all the weights apply</p>
  <Image src="nba_awards_predictor/roy_score.png" alt={""}></Image>
...
graph being built on another thread</p>
  <Image src="nba_awards_predictor/mvp_bfs.png" alt={""}></Image>
