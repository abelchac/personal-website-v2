...
`
 ...
 function Section1(){
  ...
  return (     
    ...
    <Image className="!relative" fill  src="csgo_predictor/csgo_header.png" alt={""}></Image>
 ...
 function Section6(){
  ...
  <div ref={ref}><h1>Initial Visualization</h1>
    ...
    <div className="grid grid-cols-[repeat(auto-fill,minmax(6rem,25rem))] gap-x-16 gap-y-10  justify-center">
      <Image className="!relative" fill  src="csgo_predictor/CorrelationOfFeatuersToWinResult.png" alt={""}></Image>
      <Image className="!relative" fill  src="csgo_predictor/KillsPerRoundVs.png" alt={""}></Image>
      <Image className="!relative" fill  src="csgo_predictor/AssitsPerRoundVs.png" alt={""}></Image>
      <Image className="!relative" fill  src="csgo_predictor/DeathsPerRoundVs.png" alt={""}></Image>
      <Image className="!relative" fill  src="csgo_predictor/DamagePerRoundVs.png" alt={""}></Image>
      <Image className="!relative" fill  src="csgo_predictor/HsPerRoundVs.png" alt={""}></Image>
      <Image className="!relative" fill  src="csgo_predictor/TotalRoundsVs.png" alt={""}></Image>
 ...
 function Section9(){
  ...
  return (<InView as="div" onChange={(inView, entry) => {entry.target.children[0].classList.add('show')}} className={`transition-opacity duration-1000 ${inView ? 'opacity-100 shown' : 'opacity-0'}`}>
    ...
    <Image className="!relative" fill  src="csgo_predictor/ModelAccuracy.png" alt={""}></Image>
 ...
 function Section10(){
  ...
  <div ref={ref}><h1>Analysis and Evaluation</h1>
    ...
    <div className="grid grid-cols-[repeat(auto-fill,minmax(6rem,25rem))] gap-x-16 gap-y-10  justify-center">
      <Image className="!relative" fill  src="csgo_predictor/AccuracryPerDataset.png" alt={""}></Image>
      <Image className="!relative" fill  src="csgo_predictor/PercentOfTotalDataset.png" alt={""}></Image>   
    </div>
 ...
 function Section11(){
  ...
  <div ref={ref}><h2>Model with Hidden Layers of Size 32, 32, 32, 32, 16, 16, 8</h2>
    <Image className="!relative" fill  src="csgo_predictor/Model1.png" alt={""}></Image>   
    <h2>Model with Hidden Layers of Size 15, 8</h2>
    <Image className="!relative" fill  src="csgo_predictor/Model2.png" alt={""}></Image>   
    <h2>Model with No Hidden Layers (Linear Regression)</h2>
    <Image className="!relative" fill  src="csgo_predictor/Model3.png" alt={""}></Image>   
    </div></InView>);
